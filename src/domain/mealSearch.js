...
const checkMealWord = (meal, word) => {
  ...
  const mealIngredients = Immutable.Set(meal.meal_ingredients.map(i => i.ingredient.description.toUpperCase()))
  const mealWords = mealTags.union(mealIngredients).add(meal.description.toUpperCase())
